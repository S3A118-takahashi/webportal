...
public class TaskReposirory {
	...
	public TaskEntity selectAll(String user_id) throws DataAccessException{
		...
		TaskEntity taskEntity = mappingSelectRsult(resultList);
		return taskEntity;
	}
	 /**
	  ...
	  * @return TaskEntity
	  */
	private TaskEntity mappingSelectRsult(List<Map<String, Object>> resultList) throws DataAccessException {
